...
public class Government {
  ...
  public static class Peasant { // 可以删掉 static
    public void doStuff() {
      System.out.println("hello");
    }
  }

  public class King { // 删掉 static
    public void doStuff() {
      spend();
    }
  }

  public class Mayor { // 删掉 static
    public void doStuff() {
      tax();
    }
  }

  public class Accountant { // 删掉 static
    public void doStuff() {
      report();
    }
  }

  public class Thief { // 删掉 static
    public void doStuff() {
      treasury = 0;
    }
  }

  public static class Explorer { // 可以删掉 static
