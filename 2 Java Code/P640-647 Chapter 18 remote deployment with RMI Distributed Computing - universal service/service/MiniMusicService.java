...
public class MiniMusicService implements Service {
  ...
  // The service method! All it does is display a button and the drawing service
  // (where the rectangles will eventually be painted).
  ...
  // This si all the music stuff from the Code Kitchen in Chapter12.
