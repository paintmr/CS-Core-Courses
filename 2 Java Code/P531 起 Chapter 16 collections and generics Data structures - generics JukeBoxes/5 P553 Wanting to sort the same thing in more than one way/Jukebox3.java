...
public class Jukebox3 {
  ...
  // parameter matches the type we are going to compare -- in this case Song
  // objects.)
  class ArtistCompare implements Comparator<Song> {
    public int compare(Song one, Song two) {
      // one.getArtist() becomes a String(the artist). We are letting the String
      // variables (for artist) do the actual comparison, since Strings already know
      // how to alphabetize themselves.
...
// sorting by artist
// [Deep Channel, Circles, Passenger, Pink Moon, Shiva Moon, Listen, Somersault]