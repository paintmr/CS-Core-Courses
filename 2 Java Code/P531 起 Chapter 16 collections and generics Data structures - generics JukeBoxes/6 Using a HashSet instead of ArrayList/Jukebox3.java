...
public class Jukebox3 {
  ...
  public void go() {
    ...
    // Here we create a new HashSet paramerized to hold Songs
    HashSet<Song> songSet = new HashSet<Song>();
    // HashSet has a simple addAll() method that can take another collection and use
    // it to populate the HasSet. It is the same as if we added each song one at a
    // time (except much simpler).
